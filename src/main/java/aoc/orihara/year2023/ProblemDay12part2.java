...
public class ProblemDay12part2 {


    public void runProblem() throws Exception {

        final BufferedReader br = Utils.getFile2023("day12.input.test");
...
//        line = br.readLine();
        ...
        while ((line = br.readLine()) != null) {
            String[] lineSplit0 = line.split(" ");
            String[] lineSplit = why(lineSplit0);
    ...
    private String[] why(String[] lineSplit0) {
        StringBuilder problem = new StringBuilder();
        StringBuilder problemNumber = new StringBuilder();
        boolean first = true;
        for (int i = 0; i < 5; i++) {
            if (!first) {
                problem.append("?");
                problemNumber.append(",");
            } else {
                first = false;
            }
            problem.append(lineSplit0[0]);
            problemNumber.append(lineSplit0[1]);
        }
        return new String[]{problem.toString(), problemNumber.toString()};
    }
